...
使用者自行决定是否安装和运行本扩展，并自行承担使用或误用造成的风险。因本扩展导致或与本扩展有关的系统故障、数据损失、信息泄露、账号问题、额外费用或其他直接、间接损害，在适用法律允许的范围内，作者不承担责任。
...
Users decide whether to install and run the extension at their own risk. To the maximum extent permitted by applicable law, the author is not liable for system failure, data loss, information disclosure, account issues, unexpected charges, or other direct or indirect damages arising from use or misuse of the extension.
